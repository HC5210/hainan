...
angular
  ...
  .config(function ($routeProvider, $httpProvider, $stateProvider, $urlRouterProvider, $locationProvider) {
    $stateProvider
      ...
      .state('courseCenter', {
        url: '/courseCenter?channelId&title&searchType&channelType&topicType',
      ...
      .state('featureHainan', {
        url: '/featureHainan?channelId&title&searchType',
        templateUrl: 'views/featurehainan.html',
        controller: 'FeaturehainanCtrl',
        controllerAs: 'featureHainan',
        data: {title: "特色海南"}
      })
      .state('caseTeach', {
        url: '/caseTeach?channelId&title&searchType',
        templateUrl: 'views/caseteach.html',
        controller: 'CaseteachCtrl',
        controllerAs: 'caseTeach',
        data: {title: "案例教学"}
      })
      .state('noticelist', {
        url: '/noticelist',
      ...
      .state('commentsListMore', {
        url: '/commentsListMore',
        templateUrl: 'views/commentslistmore.html',
        controller: 'CommentsListMoreCtrl',
        controllerAs: 'commentsListMore',
        data: {title: "评论更多"}
      })
      .state('newsCenter', {
        url: '/newsCenter',
      ...
      .state('article', {
        url: '/news/article?categoryCode&title&categoryId',
        data: {title: "文章"},
