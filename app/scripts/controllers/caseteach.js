...
/**
 * @ngdoc function
 * @name luZhouApp.controller:CaseteachCtrl
 * @description
 * # CaseteachCtrl
 * Controller of the luZhouApp
 */
angular.module('luZhouApp')
  .controller('CaseteachCtrl', function ($scope, $rootScope, $cookieStore, commonService, $timeout, $loading, $stateParams) {
    ...
    //   });
    commonService.getData(ALL_PORT.GetChannelInfoList.url, 'POST', ALL_PORT.GetChannelInfoList.data)
      .then(function (response) {
        $loading.finish('courseClassify');
        $scope.courseClassify = response.Data;
      });
