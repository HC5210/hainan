...
var ALL_PORT = {
  ...
  ArticleCategory: {
    ...
    data: {titleNav: '新闻分类', sort: 'Id', order: 'asc'}
  },
  //文章
  ArticleList: {
    url: API_URL + "/Page/ArticleList",
    data: {page: '1', rows: '7', sort: 'Id', order: 'desc', wordLimt: '20', CategoryCode: '', categoryId: ''}
  },
  //文章内容
  ArticleContent: {
  ...
  NoticeList: {
    ...
    data: {page: '1', rows: '10', sort: 'Id', order: 'desc', categoryId: 1, titleNav: '通告公告', wordLimt: '35'}
  },
  //通知内容
  noticeContent: {
  ...
  LeftGroupRank: {
    ...
    data: {page: 1, rows: 10, sort: "Average", order: "desc", titleNav: '单位排行', wordLimt: 9}
  },
  //单位排行详情
  RankGroupList: {
    url: API_URL + "/Page/RankGroupList",
    data: {page: 1, rows: 15, sort: "Average", order: "desc", titleNav: '单位排行', wordLimt: 30,BatchId:10}
  },
  //实时数据
  LeftRealTimeData: {
  ...
  GetChannelInfoList: {
    ...
    data: {titleNav: "课程分类", sort: 'Sort', order: 'Desc',ParentId:'187'}
  },
  //  特色海南
  GetChannelInfoListFeature: {
    url: API_URL + "/Page/GetChannelInfoList",
  ...
  RankUserList: {
    ...
    data: {page: 1, rows: 15, sort: 'TotalCredit', order: 'desc', titleNav: "个人排行",BatchId:10}
  },
  //课程完成排行
  CourseFinishList: {
